...
GREETING = "Здравствуйте! Я Марго, ваш консультант по инвестиционным апартаментам RIZALTA Resort Belokurikha. Помогу подобрать номер, рассчитать доход и ответить на вопросы по ДДУ и договору с управляющей компанией. Апартаменты от 14.3 млн, окупаемость около 6.5 лет)"
